        ...
        <div class="bg-white dark:bg-darkcard rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col min-h-[500px]">
             ...
             <div class="p-4 border-b border-gray-100 dark:border-gray-700 flex flex-wrap items-center justify-between gap-4">
                 ...
                 <div class="relative">
                     ...
                     <input v-model="searchQuery" type="text" placeholder="Search banners..." class="pl-9 pr-4 py-2 text-sm border-gray-300 dark:border-gray-600 rounded-lg dark:bg-darkbg dark:text-white focus:ring-brand-500 focus:border-brand-500 w-full sm:w-64">
                 </div>
             </div>
            ...
            <div class="overflow-x-auto flex-1">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr v-else-if="paginatedBanners.length === 0">
                             <td colspan="6" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                 No banners found.
                             </td>
                        </tr>
                        <tr v-else v-for="(banner, index) in paginatedBanners" :key="banner.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
            ...
            <AdminPagination 
                v-if="!loading && filteredBanners.length > 0"
