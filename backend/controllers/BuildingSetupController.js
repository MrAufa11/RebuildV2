...
const BuildingSetupController = {
    async getAll(req, res) {
        try {
            const records = await spmbDb.query('SELECT * FROM building_setup ORDER BY id DESC', { type: QueryTypes.SELECT });
    ...
    async create(req, res) {
        try {
            ...
            console.error('Error in create for building_setup:', error);
