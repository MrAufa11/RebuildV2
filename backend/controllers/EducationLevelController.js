...
const EducationLevelController = {
    async getAll(req, res) {
        try {
            const records = await spmbDb.query('SELECT * FROM education_level ORDER BY id DESC', { type: QueryTypes.SELECT });
    ...
    async create(req, res) {
        try {
            ...
            console.error('Error in create for education_level:', error);
