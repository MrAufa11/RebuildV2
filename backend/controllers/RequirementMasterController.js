...
const RequirementMasterController = {
    async getAll(req, res) {
        try {
            const records = await spmbDb.query('SELECT * FROM requirement_master ORDER BY id DESC', { type: QueryTypes.SELECT });
    ...
    async create(req, res) {
        try {
            ...
            console.error('Error in create for requirement_master:', error);
