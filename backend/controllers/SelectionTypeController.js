...
const SelectionTypeController = {
    async getAll(req, res) {
        try {
            const records = await spmbDb.query('SELECT * FROM selection_type ORDER BY id DESC', { type: QueryTypes.SELECT });
    ...
    async getById(req, res) {
        try {
            const [record] = await spmbDb.query('SELECT * FROM selection_type WHERE id = ?', {
    ...
    async create(req, res) {
        try {
            ...
            console.error('Error in create for selection_type:', error);
