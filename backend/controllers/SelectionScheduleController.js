...
const SelectionScheduleController = {
    async getAll(req, res) {
        try {
            const records = await spmbDb.query('SELECT * FROM selection_schedule ORDER BY id DESC', { type: QueryTypes.SELECT });
    ...
    async create(req, res) {
        try {
            ...
            console.error('Error in create for selection_schedule:', error);
