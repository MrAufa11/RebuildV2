            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-10">
                <div v-for="(teacher, index) in displayTeachers" :key="teacher.id" class="text-center group cursor-pointer" data-aos="fade-up" :data-aos-delay="index * 100">
                    <div class="relative w-40 h-40 mx-auto mb-6">
                        ...
                        <img :src="teacher.image_url || 'https://via.placeholder.com/150'" class="relative w-full h-full rounded-full object-cover border-4 border-white shadow-xl group-hover:scale-105 transition duration-500">
                    </div>
