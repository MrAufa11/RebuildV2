    ...
    <div class="bg-white dark:bg-darkcard rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-300">
        ...
        <form @submit.prevent="handleSubmit" class="p-6">
            <div class="space-y-6">
                ...
                <!-- Category -->
                <div>
                    <label for="category" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Category / Tag</label>
                    <input v-model="form.category" type="text" id="category" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-darkbg text-gray-900 dark:text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-500 sm:text-sm px-4 py-2.5 transition-colors" placeholder="e.g. Events, Sports, Campus">
                </div>
